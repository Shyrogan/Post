...
/**
 * In most project, we might want to create only a few classes that holds each of our receivers. To achieve this, Post
 * provides the {@link ReceiverFactory}, a class that looks each receivers contained inside of an object.
 */
